...
import { Settings, Globe, Lock, Bell, User, Eye, EyeOff, Save, Loader2, Camera, Users } from 'lucide-react';
...
import ConnectionRequestsPanel from '../../components/common/ConnectionRequestsPanel';

type Tab = 'profile' | 'connections' | 'privacy' | 'notifications' | 'password';
